...
//  Project8_7LittleWords
//
//  Created by Maxim on 08.06.2023.
//

import UIKit

class ViewController: UIViewController {
    var cluesLabel: UILabel! //подсказки
    ...
    override func loadView() {
        ...
        currentAnswer.isUserInteractionEnabled = false // Отключение вызова клавиатуры
        ...
        NSLayoutConstraint.activate([
            ...
            cluesLabel.topAnchor.constraint(equalTo: scoreLabel.bottomAnchor, constant: 25),
            ...
            answerLabel.trailingAnchor.constraint(equalTo: view.layoutMarginsGuide.trailingAnchor,
                                                  constant: -100),
            answerLabel.widthAnchor.constraint(equalTo: view.layoutMarginsGuide.widthAnchor,
                                               multiplier: 0.4,
                                               constant: -100),
        ...
        // Создаем 20 кнопок в виде сетки 4 на 5
        for row in 0 ..< 4 {
            for col in 0 ..< 5 {
    ...
    func loadLevel() {
        DispatchQueue.global().async {
            ...
            if let levelFileURL = Bundle.main.url(forResource: "level\(self.level)",
                                                  withExtension: "txt") {
                if let levelContents = try? String(contentsOf: levelFileURL) {
                    ...
                    for (index, line) in lines.enumerated() {
                        ...
                        let solutionWord = answer.replacingOccurrences(of: "|", with: "") // этот метод заменяет в строке то, что мы ставим в "of" на то, что стоит в "with"
